...
def upload_file_to_drive(uploaded_file, credentials_info):
...
if submit:
    ...
    if tool_image is not None:
        tool_image_link = upload_file_to_drive(tool_image, credentials_info)
    else:
        tool_image_link = ""

    if chip_image is not None:
        chip_image_link = upload_file_to_drive(chip_image, credentials_info)
    else:
        chip_image_link = ""
